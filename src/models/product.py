...
class SmartupProductTypes(Base):
  ...
  pipe_id = Column(BigInteger, primary_key=True, nullable=False)
  product_group_code = Column(String(500), primary_key=True, nullable=False)
  product_id = Column(BigInteger, primary_key=True, nullable=False)
  product_type_code = Column(String(500), nullable=False)
  
  __table_args__ = (
    Index('smartup_product_types_i1', 'pipe_id', 'product_type_code', 'product_group_code'),
    Index('smartup_product_types_i2', 'pipe_id', 'product_type_code'),
    Index('smartup_product_types_i3', 'pipe_id', 'product_group_code'),
